package org.chicha.recipes.core.screens.addplan.components
...
import org.chicha.recipes.core.screens.addplan.AddPlanViewModel
import org.chicha.recipes.core.screens.addplan.states.AddPlanState
import org.chicha.recipes.core.screens.planner.PlannerViewModel
    ...
    Column(
        ...
        Button(
            ...
            if (createMealPlanResponse.isLoading) {
                ...
                Toast.makeText(context, "Plan created for $selectedDay", Toast.LENGTH_SHORT).show()
                Text(text = "Success")
